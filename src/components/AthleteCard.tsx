...
import { AthleteProfile, STAT_METADATA, RarityTier } from '@/utils/athleteCardCalculations';
...
interface AthleteCardProps {
  ...
  format?: 'square' | 'story'; // Nuovo prop per formato
}

// Stili per i tier di rarità
...
const AthleteCard: React.FC<AthleteCardProps> = ({
  ...
  const getProfileName = () => {
    ...
    return t(`athlete_card.profiles.cycling.${profileKey}`, profileType);
  };
      ...
      >
        ...
        <div className="absolute top-[730px] left-1/2 transform -translate-x-1/2">
          <div className="relative">
            ...
            >
              <defs>
                <linearGradient id={`gradient-${rarityTier}-story`} x1="0%" y1="0%" x2="100%" y2="100%">
                  {rarityTier === 'ALIEN' && (
                    <>
              ...
              <polygon 
                ...
                fill={`url(#gradient-${rarityTier}-story)`}
                ...
                <div className="flex items-center space-x-4">
                  <div>
                    ...
                    <div className="text-sm text-slate-400 font-medium">
                      {STAT_METADATA[key as keyof typeof STAT_METADATA].duration}
                    </div>
                  </div>
                </div>
    ...
    >
      ...
      <div className="absolute top-8 right-8 z-10">
        <div className="relative">
          ...
          >
            <defs>
              <linearGradient id={`gradient-${rarityTier}-square`} x1="0%" y1="0%" x2="100%" y2="100%">
                {rarityTier === 'ALIEN' && (
                  <>
                    <stop offset="0%" stopColor="#a855f7" />
                    <stop offset="50%" stopColor="#ec4899" />
            ...
            <polygon 
              ...
              fill={`url(#gradient-${rarityTier}-square)`}
              stroke={tierStyles.ratingBorder.includes('purple') ? '#a855f7' : 
                     tierStyles.ratingBorder.includes('yellow') ? '#facc15' :
                     tierStyles.ratingBorder.includes('blue') ? '#60a5fa' :
                     '#a3e635'}
      ...
      <div className="absolute top-96 left-8 right-8 bottom-24">
        ...
        {/* Terza riga - 1 statistica centrata (STA) */}
      ...
      <div className="absolute bottom-6 left-8 right-8 text-center">
        <p className="text-slate-400 text-lg font-medium">
          Generato su <span className="text-lime-400 font-bold">miccoach.it</span>
        </p>
      </div>
